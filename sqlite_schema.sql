...
CREATE TABLE IF NOT EXISTS `stats` (
  ...
  `TIME_DB_INSTERT_REFS` integer DEFAULT NULL,
  `TIME_DB_INSTERT_READS` integer DEFAULT NULL,
  ...
  `DATE_DB_INSTERT_REFS` text DEFAULT NULL,
  `DATE_DB_INSTERT_READS` text DEFAULT NULL,
