...
int     SetDoubleHashItem(GDHASH* hash, unsigned int key1, unsigned int key2,void* data);
...
void*   GetTripleHashItem(GTHASH* hash, unsigned int key1, unsigned int key2, unsigned int key3);
